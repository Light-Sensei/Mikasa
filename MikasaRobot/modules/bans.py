...
import MikasaRobot.modules.sql.users_sql as sql
...
from MikasaRobot.modules.helper_funcs.extraction import extract_user_and_text
from MikasaRobot.modules.helper_funcs.string_handling import extract_time
from MikasaRobot.modules.log_channel import gloggable, loggable
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(text="🗑️  ᴅᴇʟᴇᴛᴇ", callback_data="unbanb_del"),
                    ]
                ]
            ),
...
def unban(update: Update, context: CallbackContext) -> Optional[str]:
    ...
    try:
        ...
        return log_message
    if user_id == bot.id:
        message.reply_text("How would I unban myself if I wasn't here bruh... u chutiya?")
        return log_message
