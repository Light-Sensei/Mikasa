...
from MikasaRobot import DRAGONS, dispatcher
...
def fullpromote(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        if err.message == "User_not_mutual_contact":
            message.reply_text("Bruh, I can't promote someone who isn't in the group.")
        else:
            message.reply_text("An error occured while promoting.")
        return
            ...
            msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇʀᴇ's ᴛʜᴇ ᴍᴇssᴀɢᴇ", url=f"{message_link}")
                        ]
                    ]
                ), 
                parse_mode=ParseMode.HTML,
...
def pinned(update: Update, context: CallbackContext) -> str:
    ...
    if chat.pinned_message:
        ...
        msg.reply_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="ʜᴇʀᴇ's ᴛʜᴇ ᴍᴇssᴀɢᴇ", url=f"https://t.me/{link_chat_id}/{pinned_id}")]]
            ),
        )
